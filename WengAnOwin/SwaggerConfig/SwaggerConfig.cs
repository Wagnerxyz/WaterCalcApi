...
public class SwaggerConfig
{
    ...
    private static string GetXmlCommentsPath()
    {
        ...
        var nn = $"{Assembly.GetExecutingAssembly().GetName().Name}.XML";
        var xmlCommentsPath = $@"{AppDomain.CurrentDomain.BaseDirectory}{name}.xml";
        return xmlCommentsPath;
    }

    private static string GetXmlCommentsPath2()
    {
        return String.Format(@"{0}\ChinaWaterLib.xml",
